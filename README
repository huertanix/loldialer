...
**NOTE**: This code is currently broken.  Like, this makes the Diaspora alpha release look like Natalie Portman levels of broken.  Working code is coming soon, but I put what I had into the cloud so I can fork and code on my N900 so I can have something to do on the PHX light rail now that I've run out of levels on Angry Birds.